    ...
    **/
    public function handle()
    {
        $this->replyWithMessage([
            'text' => 'Hi! This is a GPT-powered chat bot that asks helpful questions to help you reflect your problems and emotions. Simply get started by typing /start and respond to the question prompts like you would with any normal conversation.
