...
class TelegramChat extends Model
{
    ...
    public function generatePrompt()
    {
        ...
        $messages = $this->telegramMessages()->where('created_at', '>=', now()->subHours(6))->orderBy('created_at', 'desc')->limit($no_of_historical_messages_to_use)->get();
    ...
    public function getRandomReacquisitionMessage()
    {
        ...
        $possible_messages = [
            ...
            // the prompts below are designed for "The Work" version of the TelegramBot

            // "What's holding you back from pursuing your dreams?",
            // "Why do you think you're not ready for that opportunity in front of you?",
            // "What do you believe is preventing you from being successful?",
            // "Why do you feel you can't take on that challenge in front of you?",
            // "What are the reasons you think others are better suited for that role that you want?",
            // "What is stopping you from being more confident?",
            // "Why do you think you don’t deserve the success you’ve achieved?",
            // "What makes you feel that you’re not good enough?",
            // "Why do you hesitate to ask for what you need?",
            // "What makes you feel you don’t have enough experience to succeed?",
            // "Why do you think others won't take you seriously?",
            // "What keeps you from trusting your own abilities?",
            // "Why do you think it's impossible for you to change your situation?",
            // "What makes you believe that failure is inevitable?",
            // "Why do you feel uncomfortable sharing your ideas?",
            // "What stops you from delegating tasks to others?",
            // "Why do you think you’re not capable of leading others?",
            // "What makes you believe you can’t balance work and life successfully?",
            // "Why do you think you’re not as talented as others?",
            // "What makes you feel you can’t overcome that challenge?",
            // "Why do you think you’ll disappoint others if you try something new?",
            // "Why do you feel you can’t break that bad habit?",
            // "What makes you believe that others are more deserving of success than you?"
        ];
